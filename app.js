  ...
  return `
    <div class="ex-block" id="exblock-${ei}">
      <div class="ex-block-head">
        ...
        <button class="btn btn-success btn-sm" onclick="markAllSetsDone(${ei})" style="background:${allDone ? 'var(--success)' : 'var(--accent)'}">
          ${allDone ? '✓ Completo' : '✓ Marcar todo'}
        </button>
...
function markAllSetsDone(ei) {
  ...
  // Re-render el bloque completo
  const cont = document.getElementById('exblock-' + ei);
  if (cont) {
