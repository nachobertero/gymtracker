...
const PROGRAM = [
  {
    phase: 'FASE 1 — BASE MENTZER',
    weeks: 'Semanas 1–4',
    desc: 'Técnica limpia. Compuestos PESADOS (4-6 reps) Mentzer. Aislamiento moderado. Sin drops ni rest-pause. Progresión de carga cada semana.',
    color: '#7c3aed',
    days: [
      {
        day: 'LUNES', label: 'PECHO + TRÍCEPS', emoji: '💪',
        note: 'Pre-fútbol. Tríceps = 3 cabezas. Base sólida con peso real.',
        exercises: [
  ...
  {
    phase: 'FASE 2 — DROPS Y REST-PAUSE',
    weeks: 'Semanas 5–12',
    desc: '+1 serie en compuestos. Introducimos DROP SETS en aislamiento y REST-PAUSE en compuestos pesados. Aumenta intensidad.',
    color: '#ec4899',
    days: [
      {
        day: 'LUNES', label: 'PECHO + TRÍCEPS', emoji: '💪',
        note: 'Press banca: REST-PAUSE en último set. Tríceps con DROPS.',
        exercises: [
  ...
  {
    phase: 'FASE 3 — MÁXIMA INTENSIDAD',
    weeks: 'Semanas 13–24',
    desc: 'Pico de forma. Técnicas avanzadas: drop sets generalizados, rest-pause en todos los compuestos, superseries antagonistas. Vos lo querés, acá está.',
    color: '#f59e0b',
    days: [
      {
        day: 'LUNES', label: 'PECHO + TRÍCEPS', emoji: '💪',
        note: 'Cada set al límite. Drops + rest-pause estratégicos.',
        exercises: [
          ...
          { name: 'Fondos en paralelas (lastrados)', spec: '4×Máx + drop set' },
      ...
      },
      {
        ...
        exercises: [
          ...
          { name: '★ Dead bug 3×12 c/lado (pausa activa)', spec: '', pause: true },
        ]
      },
      {
        day: 'MIÉRCOLES', label: 'HOMBROS + CORE', emoji: '🎯',
